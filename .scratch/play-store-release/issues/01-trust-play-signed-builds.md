...
- [x] A build installed from the Google Play internal-testing opt-in path can sign in with Google and complete a representative Household, Search, and Description Generation journey without certificate or App Check failures.
...
- 2026-09-15: Uploaded the replacement bundle after the reset window, removed the stale pre-window upload failure from the draft, and published `1.0 (2) - Internal test` (version code 2). Play Console reports the release as active and available to internal testers, and the tester account remains opted in. The final Play-installed Google sign-in, Household, Search, and Description Generation journey is ready for manual verification on the connected Pixel 8 Pro.
